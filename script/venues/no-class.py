...
url = 'https://www.eventbrite.com/o/no-class-41123421913'
...
for show in shows:
  ...
  if artist.text.strip() != 'Monday Night Trivia!':
    ...
    dupe_urls.add(link) # Add the haven‘t-seen-before URL to the set so it can be counted as a dupe next time
