  ...
  return (
    show.artist && (
      <li key={i}>
        <a
          href={show.link}
          className='focus:text-gray-1000 group group flex h-full min-h-[180px] flex-col justify-between gap-y-4 rounded-md border border-gray-50 bg-gray-50/50 p-4 text-gray-700 decoration-gray-200 hover:border-gray-100 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500/50'
        >
