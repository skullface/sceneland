  ...
  return (
    show.artist && (
      <li key={i}>
        <a
          href={show.link}
          className='group flex h-full min-h-[180px] flex-col justify-between gap-y-4 rounded-md border border-gray-200 bg-white/50 p-4 leading-snug decoration-gray-200 shadow-sm transition hover:!border-gray-300 hover:underline hover:shadow-md hover:!shadow-black/5 focus:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500/50 dark:bg-gray-900/50'
        >
