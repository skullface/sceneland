...
export function VenueFilter({
  ...
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content className='dropdown-content flex min-w-[260px] flex-col rounded-xl bg-zinc-900 shadow-lg shadow-black/5 md:min-w-[360px] dark:bg-zinc-50'>
          {venues
